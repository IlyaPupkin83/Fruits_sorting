# Проект программы алгоритмических конструкций (перемешивание элементов объекта; фильтрация и сортировка свойств элементов объекта, добавление новых элементов)
